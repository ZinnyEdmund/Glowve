      ...
      <div className="">
        <div className="max-w-4xl mx-auto px-4 relative border border-white/50 rounded-3xl p-8 md:p-12 shadow-sm">
          <div className="text-center space-y-6 ">
            ...
            <h2 className="text-4xl md:text-4xl font-bold text-black">Stay in the Loop</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto pt-4">
              <input
                ...
                className="flex-1 px-6 py-4 rounded-xl border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#755757] focus:border-transparent bg-white shadow-sm text-black placeholder:text-gray-400"
              />
