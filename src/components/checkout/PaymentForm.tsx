...
export default function PaymentForm({ onSubmit, onBack, processing = false }: Props) {
      ...
      {selectedMethod === 'paystack' && (
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            <span className="font-semibold">💡 Secure Payment:</span> You'll be redirected to Paystack's secure payment page to complete your transaction.
          </p>
        </div>
      )}
      ...
      {selectedMethod === 'bank_transfer' && (
        <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-sm text-yellow-800">
            <span className="font-semibold">ℹ️ Note:</span> Bank transfer details will be provided after you place your order.
          </p>
        </div>
      )}
